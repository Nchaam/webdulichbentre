                            ...
                            <div class="tour-details">
                                <p class="card-text">
                                    <small class="text-muted">
                                        ...
                                        <i class="bi bi-calendar-event ms-3"></i> ${item.departureDate}
                                    </small>
                                </p>
                                <p class="card-text">
                                    <span class="text-primary">${item.price}</span> x ${item.quantity}
...
// Xóa bỏ phần giới hạn số lượng người
document.addEventListener('DOMContentLoaded', function() {
    const quantityInput = document.getElementById('tourQuantity');
    if (quantityInput) {
